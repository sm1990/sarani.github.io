...
<p>see the <a href="https://docs.central.ballerina.io/ballerina/websocket/latest/">WebSocket module</a>.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/websocket-service-mutual-ssl", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`# You may need to change the certificate file path, private key file path, and`}</span>
<span>{`# trusted certificate file path.`}</span>
<span>{`bal run websocket_service_mutual_ssl.bal`}</span>
</code></pre>
          </Col>
