...
export default function GraphqlInputTypes() {
...
<p>GraphQL resources can have input parameters, which will be mapped to input</p>

<p>values in the generated GraphQL schema. Currently, the supported input types</p>

<p>are: <code>string</code>, <code>int</code>, <code>boolean</code>, <code>float</code>, and <code>enum</code>. Any of these types can</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/graphql-input-types", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref2}>
      <code className="d-flex flex-column"><span>{`bal run graphql_input_types.bal`}</span>
</code></pre>
          </Col>
          <Col sm={2} className="d-flex align-items-start">
            {outputClick2 ? (
