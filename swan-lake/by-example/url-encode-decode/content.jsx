...
const codeSnippetData = [`import ballerina/url;
import ballerina/io;
...
<p>Ballerina URL API supports encoding/decoding a URL or part of a URL.&lt;br/&gt;&lt;br/&gt;</p>

<p>For more information on the underlying module,</p>

<p>see the <a href="https://docs.central.ballerina.io/ballerina/url/latest/">URL module</a>.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=af77fca35bbfc90a139122e391738618&file=url_encode_decode.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/url-encode-decode", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run url_encode_decode.bal`}</span>
...
<span>{`URL decoded value: data=value`}</span>
      ...
      <Link
        title="UTC time"
        href="/learn/by-example/time-utc"
      >
