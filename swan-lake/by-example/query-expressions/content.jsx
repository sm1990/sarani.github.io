...
export default function QueryExpressions() {
...
<p>Query-like expressions start with a <code>from</code> clause and end with a <code>select</code> clause. It is a</p>

<p>list comprehension, based on mathematical &quot;set builder&quot; notation.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=b028e147649ff88166e62c572731fe76&file=query_expressions.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/query-expressions", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run query_expressions.bal`}</span>
