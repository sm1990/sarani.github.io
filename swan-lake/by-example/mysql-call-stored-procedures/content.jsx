...
<p>This BBE demonstrates how to use the MySQL client to execute a stored</p>

<p>procedure. Note that the MySQL database driver JAR should be defined in</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/mysql-call-stored-procedures", "_blank");
      }}
