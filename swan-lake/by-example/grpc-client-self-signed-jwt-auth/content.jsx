...
export default function GrpcClientSelfSignedJwtAuth() {
...
<p>A client, which is secured with self-signed JWT can be used to connect to</p>

<p>a secured service.&lt;br/&gt;</p>

<p>The client metadata is enriched with the <code>Authorization: Bearer &lt;token&gt;</code></p>

<p>header by passing the <code>http:JwtIssuerConfig</code> to the <code>auth</code> configuration</p>

<p>of the client. A self-signed JWT is issued before the request is sent.&lt;br/&gt;&lt;br/&gt;</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/grpc-client-self-signed-jwt-auth", "_blank");
      }}
