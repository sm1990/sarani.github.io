...
export default function TempFilesDirectories() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        The Ballerina File API contains functions to perform temp file and
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=23671322d841beda787709960aa56d30&file=temp_files_directories.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/temp-files-directories",
                "_blank"
              );
            }}
