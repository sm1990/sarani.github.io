...
export default function GraphqlServiceSslTls() {
...
<p>You can use the GraphQL listener to connect to or interact with an HTTPS client.</p>

<p>Provide the <code>graphql:ListenerSecureSocket</code> configurations to the server to</p>

<p>expose an HTTPS connection.&lt;br/&gt;&lt;br/&gt;</p>

<p>For more information on the underlying module,</p>

<p>see the <a href="https://docs.central.ballerina.io/ballerina/graphql/latest/">GraphQL module</a>.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/graphql-service-ssl-tls", "_blank");
      }}
...
<span>{`bal run graphql_service_ssl_tls.bal`}</span>
</code></pre>
          </Col>
