...
export default function NatsBasicRequestReply() {
...
<p>The NATS client is used either to produce a message to a subject or consume a message from a subject.</p>

<p>In order to execute this example, it is required that a NATS server is up and running on its default host, port, and cluster.</p>

<p>For instructions on installing the NATS server,</p>

<p>go to <a href="https://docs.nats.io/nats-server/installation">NATS Server Installation</a>.&lt;br/&gt;&lt;br/&gt;</p>

<p>This is a simple request/reply messaging pattern example.</p>

<p>For more information on the underlying module,</p>

<p>see the <a href="https://docs.central.ballerina.io/ballerinax/nats/latest">NATS module</a>.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/nats-basic-request-reply", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref2}>
      <code className="d-flex flex-column"><span>{`bal run subscriber.bal`}</span>
