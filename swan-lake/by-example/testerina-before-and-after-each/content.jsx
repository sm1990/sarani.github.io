...
export default function TesterinaBeforeAndAfterEach() {
...
const ref1 = createRef()
  ...
  return (
    <Container className="d-flex flex-column h-100">
      <h1>Before and after each</h1>


<p>The function specified with the <code>BeforeEach</code> annotation is executed before every test and</p>

<p>the function specified with the <code>AfterEach</code> annotation is executed after every test within the test suite.</p>

<p>This can be used for repeatedly initializing and tearing down test level aspects before every test function.&lt;br/&gt;&lt;br/&gt;</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/testerina-before-and-after-each", "_blank");
      }}
