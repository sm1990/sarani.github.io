...
export default function TaskOneTimeJobExecution() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        A <code>task:scheduleOneTimeJob()</code> can be used to execute
        Ballerina jobs at a specific time.
      </p>

      <p>
        The <code>task:Job</code> and time should be specified to schedule the
        job.
      </p>
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=6829de8a9f88006dd29fa32bdf599e49&file=task_one_time_job_execution.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/task-one-time-job-execution",
                "_blank"
              );
            }}
