...
<p>A  <code>task:scheduleOneTimeJob()</code> can be used to execute Ballerina jobs at a specific time.</p>

<p>The <code>task:Job</code> and time should be specified to schedule the job.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=9c6fc43cfc93b23c3cf1a9e0d8e872c5&file=task_one_time_job_execution.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/task-one-time-job-execution", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run task_one_time_job_execution.bal`}</span>
