      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=fda410eba237132322da7af98663c814&file=combining_isolated_functions_and_lock.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/combining-isolated-functions-and-lock",
                "_blank"
              );
            }}
        ...
        <Col className="my-2" sm={10}>
          <pre className="m-0" ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`bal run combining_isolated_functions_and_lock.bal`}</span>
              <span>{`{"v":200}`}</span>
            </code>
          </pre>
        </Col>
