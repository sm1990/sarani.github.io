...
const codeSnippetData = [`// This is the connection oriented client implementation of the UDP socket.
import ballerina/io;
...
<p>The client remains connected until it is explicitly disconnected or until it is closed.</p>

<p>This sample demonstrates how to send data to a connected server and print the echoed response.&lt;br/&gt;&lt;br/&gt;</p>

<p>For more information on the underlying module,</p>

<p>see the <a href="https://docs.central.ballerina.io/ballerina/udp/latest">UDP module</a>.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/udp-connect-client", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run udp_connect_client.bal`}</span>
<span>{``}</span>
