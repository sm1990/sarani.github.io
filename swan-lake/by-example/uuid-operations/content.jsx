...
export default function UuidOperations() {
...
<p>The <code>uuid</code> library provides functions related to UUIDs (Universal Unique Identifiers).</p>


<p>For more information on the underlying module, see the <a href="https://docs.central.ballerina.io/ballerina/uuid/latest/">UUID module</a>.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=d0b03f61efa3cfd3c139a069efbb24e9&file=uuid_operations.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/uuid-operations", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run uuid_operations.bal`}</span>
...
<span>{`UUID record: {"timeLow":1133987422,"timeMid":13817,"timeHiAndVersion":4587,"clockSeqHiAndReserved":173,"clockSeqLo":193,"node":2485377957890}`}</span>
      ...
      <Link
        title="Generate UUID"
        href="/learn/by-example/uuid-generation"
      >
