...
export default function KafkaProducerTransactional() {
...
<p>This shows how to do transactional message producing by sending</p>

<p>messages to Kafka brokers atomically using the <code>kafka:Producer</code> client. For</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/kafka-producer-transactional", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run kafka_message_producer_transactional.bal`}</span>
<span>{`Transaction successful`}</span>
      ...
      <Link
        ...
        href="/learn/by-example/kafka-authentication-sasl-plain-consumer"
      >
