...
export default function TesterinaMockingObjects() {
...
<p>Object mocking enables controlling the values of member variables and the behavior of</p>

<p>the member functions of an object. Mocking of objects can be done in two ways. &lt;br/&gt;&lt;br/&gt;</p>
...
<ol start="2">
<li>Stubbing the member function or member variable - stubbing the behavior of functions</li>
</ol>

<p>and values of variables&lt;br/&gt;&lt;br/&gt;</p>

<p>Creating a test double is suitable when a single mock function/object can be used</p>

<p>throughout all tests whereas stubbing is ideal when defining different behaviors for</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/testerina-mocking-objects", "_blank");
      }}
