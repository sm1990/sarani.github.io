...
<p>This BBE demonstrates how to use the JDBC client to execute a batch of</p>

<p>DDL/DML operations with the help of a <code>transaction</code> to achieve the atomic behaviour.</p>

<p>Note that the relevant database driver JAR should be defined in the <code>Ballerina.toml</code></p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/jdbc-atomic-batch-execute-operation", "_blank");
      }}
