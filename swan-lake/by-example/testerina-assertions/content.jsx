...
const codeSnippetData = [`import ballerina/test;
...
export default function TesterinaAssertions() {
...
<p>This example illustrates how to use different assertions.&lt;br/&gt;&lt;br/&gt;</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/testerina-assertions", "_blank");
      }}
...
<span>{`                [pass] testAssertFalse`}</span>
