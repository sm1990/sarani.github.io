...
export default function WebsocketClientOauth2RefreshTokenGrantType() {
...
<p>passing the <code>websocket:OAuth2RefreshTokenGrantConfig</code> to the <code>auth</code></p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/websocket-client-oauth2-refresh-token-grant-type", "_blank");
      }}
