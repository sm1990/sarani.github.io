...
export default function InterWorkerFailurePropagation() {
...
const ref1 = createRef()
  ...
  return (
    <Container className="d-flex flex-column h-100">
      <h1>Inter-worker failure propagation</h1>


<p>Workers may need to call functions that can return an <code>error</code>.</p>

<p>Pairing up of sends and receives guarantees that each send will be</p>

<p>received, and vice-versa, provided neither sending nor receiving worker</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=0529e0af59a8bd02ee97a95d409f4749&file=inter_worker_failure_propagation.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/inter-worker-failure-propagation", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run inter_worker_failure_propagation.bal`}</span>
<span>{`42`}</span>
