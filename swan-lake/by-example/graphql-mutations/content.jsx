...
<p>A remote function inside a GraphQL service represents a field in the root</p>

<p><code>Mutation</code> object type. Therefore, if a remote function is present inside</p>

<p>the Ballerina GraphQL service, the auto-generated schema will have a</p>

<p><code>Mutation</code> type. Each remote function in the service will be added as a</p>

<p>field of the <code>Mutation</code> type. The field name will be the remote function</p>

<p>name and the field type will be the return type of the remote function.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/graphql-mutations", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref2}>
      <code className="d-flex flex-column"><span>{`bal run graphql_mutations.bal`}</span>
</code></pre>
          </Col>
          <Col sm={2} className="d-flex align-items-start">
            {outputClick2 ? (
