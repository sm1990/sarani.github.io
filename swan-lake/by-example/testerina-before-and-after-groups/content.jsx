...
export default function TesterinaBeforeAndAfterGroups() {
...
const ref1 = createRef()
  ...
  return (
    <Container className="d-flex flex-column h-100">
      <h1>Before and after groups</h1>


<p>The function specified with the <code>BeforeGroups</code> annotation is executed once before all the tests belonging to the</p>

<p>specified group is executed and the function specified with the <code>AfterGroups</code> annotation is executed once after all</p>

<p>the tests belonging to the specified group is executed.&lt;br/&gt;&lt;br/&gt;</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/testerina-before-and-after-groups", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal test test_module`}</span>
<span>{``}</span>
...
<span>{`	0 skipped`}</span>
      ...
      <Link
        ...
        href="/learn/by-example/testerina-before-and-after-each"
      >
