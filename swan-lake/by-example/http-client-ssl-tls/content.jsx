...
export default function HttpClientSslTls() {
...
<p>You can use the HTTPS client to connect or interact with an HTTPS listener.</p>

<p>Provide the <code>http:ClientSecureSocket</code> configurations to the client to</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/http-client-ssl-tls", "_blank");
      }}
