...
<p>Ballerina provides support for interacting with a transaction manager.</p>

<p>Compile-time guarantees that transactions are bracketed with begin and <code>commit</code> or <code>rollback</code>.</p>

<p>The region in the middle is typed as being a transactional context.</p>

<p>Ballerina does not have a transactional memory and includes a transaction manager.</p>

<p>The current transaction is a part of the execution context of a strand.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=502f33f7929fa7dad7f508284c6d7f22&file=transaction_statement.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/transaction-statement", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run transaction_statement.bal`}</span>
