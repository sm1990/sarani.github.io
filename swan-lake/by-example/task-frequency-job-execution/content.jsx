...
export default function TaskFrequencyJobExecution() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        A <code>task:scheduleJobRecurByFrequency()</code> can be used to execute
        Ballerina jobs periodically.
      </p>

      <p>
        The <code>task:Job</code> and interval should be specified and optional
        configurations are start time,
      </p>
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=5316fb12f639e18884fefe626a6a2b72&file=task_frequency_job_execution.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/task-frequency-job-execution",
                "_blank"
              );
            }}
        ...
        <Col className="my-2" sm={10}>
          <pre className="m-0" ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`bal run task_frequency_job_execution.bal`}</span>
      ...
      <Row className="mt-auto mb-5">
        <Col sm={6}>
          <Link title="Random numbers" href="/learn/by-example/random-numbers">
