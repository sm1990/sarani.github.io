...
export default function HttpClientOauth2JwtBearerGrantType() {
...
<p>passing the <code>http:OAuth2JwtBearerGrantConfig</code> to the <code>auth</code></p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/http-client-oauth2-jwt-bearer-grant-type", "_blank");
      }}
...
<span>{`Hello, World!`}</span>
      ...
      <Link
        title="Redirects"
        href="/learn/by-example/http-redirects"
      >
