...
const codeSnippetData = [`import ballerinax/awslambda;
...
<p>a Ballerina function with &quot;@awslambda:Function&quot;, which should have</p>

<p>the function signature <code>function (awslambda:Context, json|EventType) returns json|error</code>.&lt;br/&gt;&lt;br/&gt;</p>

<p>For more information, see the <a href="https://ballerina.io/learn/deployment/aws-lambda/">AWS Lambda Deployment Guide</a>.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/aws-lambda-deployment", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`# Prerequisites: AWS CLI tools installation and configuration. Visit [AWS Lambda Deployment Guide](https://ballerina.io/learn/deployment/aws-lambda/) for detailed steps.`}</span>
<span>{``}</span>
