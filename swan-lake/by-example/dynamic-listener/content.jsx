...
const ref2 = createRef()
  ...
  return (
    <Container className="d-flex flex-column h-100">
      <h1>Dynamic listener</h1>


<p>Dynamic listeners allow registering/deregistering a module listener dynamically.</p>

<p>This example demonstrates how to register and deregister an HTTP listener</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/dynamic-listener", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`# Invoke the service using "cURL".`}</span>
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref2}>
      <code className="d-flex flex-column"><span>{`# Navigate to the directory that contains the`}</span>
