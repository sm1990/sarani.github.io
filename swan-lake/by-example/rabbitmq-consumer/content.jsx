...
<p>The Ballerina RabbitMQ connection used here can be re-used to create</p>

<p>multiple channels.</p>

<p>Multiple services consuming messages from the same queue or from</p>

<p>different queues can be attached to the same Listener.&lt;br/&gt;&lt;br/&gt;</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/rabbitmq-consumer", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run rabbitmq_consumer.bal`}</span>
