  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=bcfdfc70aeb5e04a7bd7a09515f186f7&file=isolated_functions.bal",
                "_blank"
              );
            }}
            target="_blank"
        ...
        <Col className="my-2" sm={10}>
          <pre className="m-0" ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`bal run isolated_functions.bal`}</span>
              <span>{`{"v":200}`}</span>
              <span>{`{"v":100}`}</span>
            </code>
          </pre>
      ...
      <Row className="mt-auto mb-5">
        ...
        <Col sm={6}>
          <Link title="Readonly type" href="/learn/by-example/readonly-type">
