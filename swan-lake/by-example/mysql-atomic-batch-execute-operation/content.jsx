...
export default function MysqlAtomicBatchExecuteOperation() {
...
<p>This BBE demonstrates how to use the MySQL client to execute a batch of</p>

<p>DDL/DML operations with the help of a <code>transaction</code> to achieve the atomic behaviour.</p>

<p>Note that the MySQL database driver JAR should be defined in</p>

<p>the <code>Ballerina.toml</code> file as a dependency.</p>

<p>For a sample configuration and more information on the underlying module, see the <a href="https://docs.central.ballerina.io/ballerinax/mysql/latest/">MySQL module</a>.</p>

<p>The MySQL connector uses database properties from MySQL version 8.0.13 onwards. Therefore, it is</p>

<p>recommended to use a MySQL driver version greater than 8.0.13.&lt;br&gt;&lt;br&gt;</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/mysql-atomic-batch-execute-operation", "_blank");
      }}
