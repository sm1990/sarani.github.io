...
export default function Filepaths() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        The Ballerina File API also contains utility functions to manipulate
        file paths in a way that is compatible with the
      </p>
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=3a443b52ab8014ddf03a1fe9f9c6d139&file=filepaths.bal",
                "_blank"
              );
            }}
            target="_blank"
        ...
        <Col className="my-2" sm={10}>
          <pre className="m-0" ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`bal run filepaths.bal`}</span>
              <span>{`On Unix:`}</span>
