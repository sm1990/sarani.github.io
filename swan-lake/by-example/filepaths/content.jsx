...
const codeSnippetData = [`import ballerina/file;
import ballerina/io;
...
<p>The Ballerina File API also contains utility functions to manipulate file paths in a way that is compatible with the</p>

<p>target operating system.&lt;br/&gt;&lt;br/&gt;</p>

<p>For more information on the underlying module,</p>

<p>see the <a href="https://docs.central.ballerina.io/ballerina/file/latest/">File module</a>.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=8b20025d28b6902b51286373238c09c4&file=filepaths.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/filepaths", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run filepaths.bal`}</span>
<span>{`On Unix:`}</span>
<span>{`Absolute path of test.txt: /A/test.txt`}</span>
<span>{`/A/B/C is absolute: true`}</span>
<span>{`Filename of /A/B/C: C`}</span>
<span>{`Parent of /A/B/C: /A/B`}</span>
<span>{`Normalized path of foo/../bar: bar`}</span>
...
<span>{`Relative path between 'a/b/c' and 'a/c/d': ..\\..\\c\\d`}</span>
      ...
      <Link
        title="Directories"
        href="/learn/by-example/directories"
      >
