...
<p>This BBE demonstrates how to use the MySQL client select query operations</p>

<p>with the stream return type. Note that the MySQL database driver JAR should</p>

<p>be defined in the <code>Ballerina.toml</code> file as a dependency.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/mysql-query-operation", "_blank");
      }}
...
<span>{`Customer details: {"customerId":2,"firstName":"Dan","lastName":"Brown","registrationId":2,"creditLimit":10000.0,"country":"UK"}`}</span>
      ...
      <Link
        title="Listener"
        href="/learn/by-example/sftp-listener"
      >
