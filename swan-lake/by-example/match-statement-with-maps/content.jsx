...
<p>Patterns on the left hand side in a match statement can have variable</p>

<p>parts that can be captured.</p>

<p>Useful for working directly with <code>json</code>.</p>

<p>Match semantics are open (may have fields other than those specified in the pattern).</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=503fb54a80616abf22403c75beced1f0&file=match_statement_with_maps.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/match-statement-with-maps", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run match_statement_with_maps.bal`}</span>
