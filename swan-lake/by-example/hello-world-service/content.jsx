...
<p>This example demonstrates the network primitives in the language that make it simpler to develop services.</p>
...
<Row className="bbeCode px-2 py-0 rounded">
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/hello-world-service", "_blank");
      }}
    >
      <svg
...
<Row className="bbeOutput p-2 rounded">
  <pre className="m-0">
    <code className="d-flex flex-column"><span>{`bal run hello_world_service.bal`}</span>
</code></pre></Row>
      ...
      <Link
        ...
        href="/learn/by-example/hello-world"
      >
