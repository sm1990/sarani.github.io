...
export default function AnyType() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        The <code>lang.value</code> lang library contains functions that apply
        to multiple basic types.
      </p>
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=79780f7009b504605b63cf25891108c3&file=any_type.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/any-type",
                "_blank"
              );
            }}
