...
export default function CacheInvalidation() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        The Ballerina Cache API provides an in-memory cache implementation by
        default with the
      </p>
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=3527d281b5e688a49b8f1e31388b493f&file=cache_invalidation.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/cache-invalidation",
                "_blank"
              );
            }}
        ...
        <Col className="my-2" sm={10}>
          <pre className="m-0" ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`bal run cache_invalidation.bal`}</span>
