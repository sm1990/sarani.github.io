...
export default function WebsocketClientSslTls() {
...
<p>You can use the WSS client to connect or interact with an WSS listener.</p>

<p>Provide the <code>websocket:ClientSecureSocket</code> configurations to the client to</p>

<p>initiate an WSS connection.&lt;br/&gt;&lt;br/&gt;</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/websocket-client-ssl-tls", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`# As a prerequisite, start a sample service secured with SSL.`}</span>
