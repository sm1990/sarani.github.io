...
<Row className="bbeCode px-2 py-0 rounded">
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=304276957a494656e25f21733f0c7abe&file=creating_tables_with_query.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/creating-tables-with-query", "_blank");
      }}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
