...
<p>A variable has a type, which constrains what values the variable can hold.</p>

<p>There is a built-in set of named types, including <code>int</code>, <code>float</code>, <code>boolean</code>, <code>string</code>.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=9cad419fe64f15c49e01367d3bef16a7&file=variables_and_types.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/variables-and-types", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run variables_and_types.bal`}</span>
<span>{`Hello Ballerina`}</span>
      ...
      <Link
        title="Identifiers"
        href="/learn/by-example/identifiers"
      >
