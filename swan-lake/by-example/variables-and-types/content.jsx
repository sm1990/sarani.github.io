...
export default function VariablesAndTypes() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        There is a built-in set of named types, including <code>int</code>,{" "}
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=a2cd12b59e95a763d111fb60642d5aac&file=variables_and_types.bal",
                "_blank"
              );
            }}
            target="_blank"
