...
export default function JdbcExecuteOperation() {
...
<p>This BBE demonstrates how to use the JDBC client with DDL and</p>

<p>DML operations. Note that the relevant database driver JAR</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/jdbc-execute-operation", "_blank");
      }}
