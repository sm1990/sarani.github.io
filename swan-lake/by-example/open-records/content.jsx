...
<p>Record types are open by default. They allow fields other than those specified. The type of unspecified</p>

<p>fields is <code>anydata</code>. Records are <code>maps</code>. Open records belong to <code>map&lt;anydata&gt;</code>. Use quoted keys for</p>

<p>fields not mentioned in the <code>record</code> type.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=1195b9d45afb7d14ea7787b32f19082d&file=open_records.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/open-records", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run open_records.bal`}</span>
