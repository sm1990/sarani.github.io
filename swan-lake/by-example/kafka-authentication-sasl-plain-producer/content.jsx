...
export default function KafkaAuthenticationSaslPlainProducer() {
...
const ref1 = createRef()
  ...
  return (
    <Container className="d-flex flex-column h-100">
      <h1>SASL authentication - producer</h1>


<p>This shows how the SASL/PLAIN authentication is done in the <code>kafka:Producer</code>.</p>

<p>For this to work properly, an active Kafka server must be present</p>

<p>and it should be configured to use the SASL/PLAIN authentication mechanism.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/kafka-authentication-sasl-plain-producer", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run kafka_authentication_sasl_plain_producer.bal`}</span>
