...
export default function ResourceMethods() {
...
<p>Service objects use <code>remote</code> methods to expose services in procedural style: remote methods are named by verbs. &lt;br/&gt;&lt;br/&gt;</p>

<p>Service objects use <code>resource</code> methods to expose services in an RESTful style: resources are named by nouns. &lt;br/&gt;&lt;br/&gt;</p>

<p>Resources are motivated by HTTP, but are general enough also to work for GraphQL.</p>

<p><code>resource</code> methods are a network-oriented generalization of OO getter/setter concept.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/resource-methods", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`# Run this cURL command to invoke the resource.`}</span>
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref2}>
      <code className="d-flex flex-column"><span>{`bal run resource_methods.bal`}</span>
</code></pre>
          </Col>
          <Col sm={2} className="d-flex align-items-start">
            {outputClick2 ? (
