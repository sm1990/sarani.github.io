...
<p><code>T1|T2</code> is the union of the sets described by <code>T1</code> and <code>T2</code>. <code>T?</code> is completely equivalent to <code>T|()</code>.</p>

<p>Unions are untagged. The <code>is</code> operator tests whether a value belongs to a specific type. The <code>is</code> operator in</p>

<p>the condition causes the declared type to be narrowed.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=ba26be43de495fd4084fc6e8f53cfd0d&file=unions.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/unions", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run unions.bal`}</span>
