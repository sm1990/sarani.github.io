...
export default function Unions() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        Unions are untagged. The <code>is</code> operator tests whether a value
        belongs to a specific type. The <code>is</code> operator in
      </p>
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=ada79ffb21102b7c59e259d00c58c543&file=unions.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/unions",
                "_blank"
              );
            }}
