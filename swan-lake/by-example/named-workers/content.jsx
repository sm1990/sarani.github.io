...
export default function NamedWorkers() {
...
<p>Normally all of a function's code belongs to the function's default worker,</p>

<p>which has a single logical thread of control.</p>

<p>A function can also declare named workers, which run concurrently with the</p>

<p>function's default worker and other named workers.</p>

<p>Code before any named workers is executed before named workers start.</p>

<p>Variables declared before all named workers and function parameters are</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=dfb76508335c962f60c91c02ffb8cc55&file=named_workers.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/named-workers", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run named_workers.bal`}</span>
