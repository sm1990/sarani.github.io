...
<Row className="bbeCode px-2 py-0 rounded">
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=ec1b538c2742cd5da37b57e9e4b55137&file=converting_to_user_defined_type.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/converting-to-user-defined-type", "_blank");
      }}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
