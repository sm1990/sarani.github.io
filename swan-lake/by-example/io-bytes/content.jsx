...
export default function IoBytes() {
...
<p>The Ballerina <code>io</code> library contains APIs to read/write bytes from/to a file.&lt;br/&gt;&lt;br/&gt;</p>

<p>For more information on the underlying module,</p>

<p>see the <a href="https://docs.central.ballerina.io/ballerina/io/latest/">IO module</a>.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/io-bytes", "_blank");
      }}
...
<span>{`# and add an image file named `}<code>{`ballerina.jpg`}</code>{` in it as follows.`}</span>
<span>{`# tree .`}</span>
<span>{`# ├── files`}</span>
...
<span>{`Successfully copied the image as a stream.`}</span>
      ...
      <Link
        ...
        href="/learn/by-example/io-strings"
      >
