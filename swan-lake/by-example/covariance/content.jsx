...
const codeSnippetData = [`int[] iv = [1, 2, 3];
...
<p>Static type-checking guarantees that the result of a read from a mutable</p>

<p>structure will be consistent with the static type.</p>

<p>Covariance means that a write to a mutable structure may result in a</p>

<p>runtime error.</p>

<p>Arrays, maps, and records have an &quot;inherent&quot; type that constrains mutation.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=289b06630d79ccaa6e25af78ea49d50c&file=covariance.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/covariance", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run covariance.bal`}</span>
