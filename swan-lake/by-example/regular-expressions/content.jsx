  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        ...
        <code>regular expression</code>.&lt;br/&gt;&lt;br/&gt;
      </p>
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=9e0829de83f601849cacd48dc8b8f36f&file=regular_expressions.bal",
                "_blank"
              );
            }}
            target="_blank"
        ...
        <Col className="my-2" sm={10}>
          <pre className="m-0" ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`bal run regex_expressions.bal`}</span>
