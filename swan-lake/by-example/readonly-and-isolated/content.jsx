...
<Row className="bbeCode px-2 py-0 rounded">
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=5192b434abe1c035b09e20982b6d4998&file=readonly_and_isolated.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/readonly-and-isolated", "_blank");
      }}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
