...
export default function ReadonlyAndIsolated() {
...
const ref1 = createRef()
  ...
  return (
    <Container className="d-flex flex-column h-100">
      <h1>Readonly and isolated</h1>


<p><code>isolated</code> functions can access <code>final</code> variables with <code>readonly</code> type without locking. It relies on the fact that</p>

<p>immutability is deep. <code>isolated</code> for functions complements <code>readonly</code> for data.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=63ba7b3fbff0d800a9f247522298c0f1&file=readonly_and_isolated.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/readonly-and-isolated", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run readonly_and_isolated.bal`}</span>
