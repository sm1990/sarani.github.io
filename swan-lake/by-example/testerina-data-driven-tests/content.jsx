...
export default function TesterinaDataDrivenTests() {
...
<p>The Ballerina Test framework provides in-built support for data-driven tests.&lt;br/&gt;&lt;br/&gt;</p>

<p>You can specify a function that returns a set of data values as a data-provider to a test function.</p>

<p>The test execution will iterate the same test function over the provided dataset.&lt;br/&gt;&lt;br/&gt;</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/testerina-data-driven-tests", "_blank");
      }}
