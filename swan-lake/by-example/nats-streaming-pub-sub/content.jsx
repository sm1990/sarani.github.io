...
export default function NatsStreamingPubSub() {
...
<p>The <code>nats</code> streaming library provides the functionality of a basic publish/subscribe.</p>

<p>In order to run this sample, a NATS Streaming server should be</p>

<p>running on the corresponding port used in the sample.&lt;br/&gt;&lt;br/&gt;</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/nats-streaming-pub-sub", "_blank");
      }}
