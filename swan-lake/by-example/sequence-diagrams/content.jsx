...
<p>&lt;img src=&quot;/learn/by-example/images/sequence-diagram.png&quot; alt=&quot;Sequence Diagrams&quot; width=&quot;600&quot; height=&quot;500&quot;&gt;</p>

<p>&lt;br/&gt;&lt;br/&gt;</p>

<p>The diagram has a lifeline (vertical line) for each worker (both named</p>

<p>worker and function's default worker).</p>

<p>The diagram also has a lifeline for each client object parameter or variable in</p>

<p>the initialization section, representing the remote system to which the client</p>

<p>object is sending messages.</p>

<p>Each remote method call on a client object is represented as a horizontal line</p>

<p>between the lifeline of the worker making the call and the remote system.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=de38e550f28e971ea65f0698f8652a63&file=sequence_diagrams.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/sequence-diagrams", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run sequence_diagrams.bal`}</span>
<span>{`Hello World`}</span>
      ...
      <Link
        title="Named workers"
        href="/learn/by-example/named-workers"
      >
