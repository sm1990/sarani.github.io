...
<p>Key fields can be structured as long as they belong to any subtype of plain data. The value of the key field</p>

<p>must be immutable. The initializer of the <code>readonly</code> field will be constructed as immutable. In other cases,</p>

<p>can use <code>cloneReadOnly()</code> to create an immutable value.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=1fd56e0f6f3ac3d50ee8fec2ee1d87a8&file=structured_keys.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/structured-keys", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run structured_keys.bal`}</span>
