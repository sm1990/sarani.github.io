...
export default function TcpTransportSecurity() {
...
<p>(i.e., the server is verified by the client). This example uses the Ballerina</p>
...
<p>see the <a href="https://docs.central.ballerina.io/ballerina/tcp/latest">TCP module</a>.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/tcp-transport-security", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`# You may need to change the trusted certificate file path.`}</span>
