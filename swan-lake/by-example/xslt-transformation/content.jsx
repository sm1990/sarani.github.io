...
export default function XsltTransformation() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        The Ballerina <code>xslt</code> library contains an API to transform XML
        content to HTML using XSL transformation.
      </p>
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=c3b921179eb3b770623d2d4a82a2fc62&file=xslt_transformation.bal",
                "_blank"
              );
            }}
            target="_blank"
