...
<p>The <code>nats</code> streaming library allows creating durable subscriptions.</p>
...
<p>remember their position even if the client is disconnected.&lt;br/&gt;&lt;br/&gt;</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/nats-streaming-durable-subscriptions", "_blank");
      }}
