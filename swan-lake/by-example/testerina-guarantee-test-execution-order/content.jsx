...
export default function TesterinaGuaranteeTestExecutionOrder() {
...
const ref1 = createRef()
  ...
  return (
    <Container className="d-flex flex-column h-100">
      <h1>Guarantee test execution order</h1>


<p>The <code>dependsOn</code> attribute can be used to define a list of functions that the test</p>

<p>function depends on. These functions will be executed before the execution of that test.&lt;br/&gt;&lt;br/&gt;</p>

<p>This allows you to ensure that the tests are being executed in the expected order.&lt;br/&gt;&lt;br/&gt;</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/testerina-guarantee-test-execution-order", "_blank");
      }}
