...
const codeSnippetData = [`import ballerina/websocket;
...
<p>A WebSocket service can be secured with Basic Auth and optionally by</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/websocket-service-basic-auth-file-user-store", "_blank");
      }}
