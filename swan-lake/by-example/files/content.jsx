...
export default function Files() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        The Ballerina File API contains functions to perform file-system
        operations.&lt;br/&gt;&lt;br/&gt;
      </p>
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=b1132a16f00d8f733e07d1bc1af90f9f&file=files.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/files",
                "_blank"
              );
            }}
