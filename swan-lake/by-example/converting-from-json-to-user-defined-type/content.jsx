      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=19cfdd58e386bae603434bd81ddba074&file=converting_from_json_to_user_defined_type.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/converting-from-json-to-user-defined-type",
                "_blank"
              );
            }}
        ...
        <Col className="my-2" sm={10}>
          <pre className="m-0" ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`bal run converting_from_json_to_user_defined_type.bal`}</span>
              <span>{`1.0`}</span>
              <span>{`2.0`}</span>
            </code>
          </pre>
