...
<p>A module can contain <code>class</code> definitions.</p>
...
<p><code>private</code> means accessible only by code within the <code>class</code> definition.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=1ca7831b57ec14c6e4696fe72ea4f9ef&file=defining_classes.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/defining-classes", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run defining_classes.bal`}</span>
<span>{`12`}</span>
</code></pre>
          </Col>
