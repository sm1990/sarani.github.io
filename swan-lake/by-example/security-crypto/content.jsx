...
const codeSnippetData = [`import ballerina/crypto;
import ballerina/io;
...
<p>The <code>crypto</code> stdlib provides functions usable to perform different cryptographic operations such as</p>

<p>hashing, HMAC generation, checksum generation, encryption, decryption, digitally signing data and</p>

<p>verifying digitally signed data.&lt;br/&gt;&lt;br/&gt;</p>

<p>For more information on the underlying module,</p>

<p>see the <a href="https://docs.central.ballerina.io/ballerina/crypto/latest/">Crypto module</a>.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/security-crypto", "_blank");
      }}
