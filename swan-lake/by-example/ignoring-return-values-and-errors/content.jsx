...
export default function IgnoringReturnValuesAndErrors() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        <code>checkpanic</code> is like <code>check</code>, but panics on error
        rather than
      </p>
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=a7aed0ca49fbf437428da22210a9f5ce&file=ignoring_return_values_and_errors.bal",
                "_blank"
              );
            }}
            target="_blank"
