...
export default function XmlNavigation() {
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=2e88d2b2626b08a0ba6591365423b9d7&file=xml_navigation.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/xml-navigation", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run xml_navigation.bal`}</span>
<span>{`<items>`}</span>
<span>{`            <!--Contents-->`}</span>
<span>{`            <book>`}</span>
...
<span>{`        `}</span>
<span>{`<planner>Daily Planner<kind>day</kind><pages>365</pages></planner>`}</span>
<span>{`<planner>Daily Planner<kind>day</kind><pages>365</pages></planner><pen><kind>marker</kind><color>blue</color></pen>`}</span>
<span>{`<book>`}</span>
<span>{`                <name>A Study in Scarlet</name>`}</span>
<span>{`                <author><name>Arthur Conan Doyle</name></author>`}</span>
<span>{`            </book><planner>Daily Planner<kind>day</kind><pages>365</pages></planner><book>`}</span>
<span>{`                <name>The Sign of Four</name>`}</span>
<span>{`                <author><name>Arthur Conan Doyle</name></author>`}</span>
<span>{`            </book><pen><kind>marker</kind><color>blue</color></pen>`}</span>
<span>{`<name>A Study in Scarlet</name><name>Arthur Conan Doyle</name><name>The Sign of Four</name><name>Arthur Conan Doyle</name>`}</span>
<span>{`<book>`}</span>
<span>{`                <name>A Study in Scarlet</name>`}</span>
<span>{`                <author><name>Arthur Conan Doyle</name></author>`}</span>
<span>{`            </book>`}</span>
      ...
      <Link
        title="XML subtyping"
        href="/learn/by-example/xml-subtyping"
      >
