...
export default function KafkaConsumerService() {
...
<p>For this to work properly, an active Kafka broker should be present.&lt;br/&gt;&lt;br/&gt;</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/kafka-consumer-service", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run kafka_consumer_service.bal`}</span>
</code></pre>
          </Col>
      ...
      <Link
        title="Producer"
        href="/learn/by-example/kafka-producer"
      >
