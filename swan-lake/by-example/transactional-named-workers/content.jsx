...
export default function TransactionalNamedWorkers() {
...
<p>A named worker within a transactional function can be declared as <code>transactional</code>.</p>

<p>This will start a new transaction branch for the named worker, as with a distributed transaction.</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=fd53eec7f1d0c52770f5388a99ce1dc0&file=transactional_named_workers.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/transactional-named-workers", "_blank");
      }}
...
<Row className="bbeOutput mx-0 px-2 rounded">
  <Col className="my-2" sm={10}>
    <pre className="m-0" ref={ref1}>
      <code className="d-flex flex-column"><span>{`bal run transactional_named_workers.bal`}</span>
