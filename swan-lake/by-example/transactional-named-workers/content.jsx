...
<Row className="bbeCode px-2 py-0 rounded">
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    <button
        ...
        onClick={() => {
          window.open(
            "https://play.ballerina.io/?gist=c11b42cd1f7b25aaca5d5320aa862683&file=transactional_named_workers.bal",
            "_blank"
          );
        }}
        target="_blank"
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/transactional-named-workers", "_blank");
      }}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
