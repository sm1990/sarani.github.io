...
export default function HttpClientSelfSignedJwtAuth() {
...
<p>passing the <code>http:JwtIssuerConfig</code> to the <code>auth</code> configuration of the</p>

<p>client. A self-signed JWT is issued before the request is sent.&lt;br/&gt;&lt;br/&gt;</p>
...
<Row className="bbeCode mx-0 px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
  ...
  <Col className="d-flex align-items-start pt-2" sm={2}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.0/http-client-self-signed-jwt-auth", "_blank");
      }}
