    ...
    <Col xs={12}>
        ...
        <Row>
          <Col xs={12} md={4} lg={4} className={styles.card}>
            ...
            <p>Make Ballerina better by contributing to its source code. Read the <a className={styles.getStartLinks} target="_blank" href="https://github.com/ballerina-platform/ballerina-lang/blob/master/CONTRIBUTING.md" >contribution guide</a> and  get started. Happy contributing!</p>
          </Col>
          <Col xs={12} md={4} lg={4} className={styles.card}>
            ...
            <p>Let the whole community benefit from your work by <a className={styles.getStartLinks} target="_blank" href="https://ballerina.io/learn/publishing-packages-to-ballerina-central/" >
                creating and publishing</a> your own module to <a className={styles.getStartLinks} target="_blank" href="https://central.ballerina.io/" >Ballerina Central</a>. </p>
          </Col>
          <Col xs={12} md={4} lg={4} className={styles.card}>
        ...
        <Row>
            ...
            <Col xs={12} md={4} lg={4} className={styles.card}>
                ...
                <p>Get invovled in any technical discussions by joining the <a className={styles.getStartLinks} target="_blank" href="https://groups.google.com/g/ballerina-dev">Ballerina Dev Google group</a>.</p>
            </Col>
